...
var calendar_offsetLeft = 0; //19	// Offset - calendar placement - You probably have to modify this value if you're not using a strict doctype
...
var selectBoxRolloverBgColor = '#EDF6FF'; // Background color on drop down lists(rollover)
...
function closeCalendar()
{
	...
	document.getElementById('hourDropDown').style.display='none';
	document.getElementById('minuteDropDown').style.display='none';
//	document.getElementById('calendarDivFondo').style.display='none';
...
function writeCalendarContent()
{
   ...
   if (showWeekNumber) {
      var cell = row.insertCell(-1);
	   ...
	   cell.style.color='#000000';/*color letra Sem*/
	}
...
function initCalendar()
{
	if(MSIE){
		...
		//
		//Creando El Fondo Principal del DIV
//	    var divPrincipal = document.createElement('DIV');
//	    divPrincipal.id = 'calendarDivFondo';
//	    //divPrincipal.style.filter = 'alpha(opacity=0)';
//	    //divPrincipal.style.position = 'absolute';
//	    divPrincipal.style.zIndex = '0'; 
//	    divPrincipal.style.top='0';
//	    divPrincipal.style.left='0';
//	    divPrincipal.style.height = '100%';
//	    divPrincipal.style.width = '100%';
//	    divPrincipal.style.backgroundColor='#ECEFF9';
//	    //divPrincipal.onmousedown = closeCalendar;
//	    
//	    document.body.appendChild(divPrincipal);
//	    document.body.attachEvent("onmousedown", closeCalendarMouse);
	}

	calendarDiv = document.createElement('DIV');
	calendarDiv.id = 'calendarDiv';
	calendarDiv.style.zIndex = 1000000;
...
function DatetimePicker(inputField,format,buttonObj,nivel_image,posicion)
{
    var nivel = "";
    var num;
    //alert(nivel_image);
    for (num=0; num<nivel_image; num++)
    {
        nivel = nivel + "../";  
    }
    pathToImages = nivel+"Scripts/General/DatetimePicker/Imagenes/";
    //
    if (posicion=='DI') //Derecha Inferior
    {
        calendar_offsetTop=0;
        calendar_offsetLeft=0;
    }
    else if (posicion=='DM') //Derecha Medio
    {
        calendar_offsetTop=-100;
        calendar_offsetLeft=19;
    }
    else if (posicion=='DS') //Derecha Superior
    {
        calendar_offsetTop=-180;
        calendar_offsetLeft=19;
    }
    else if (posicion=='II') //Izquierda Inferior
    {
        calendar_offsetTop=0;
        calendar_offsetLeft=-193;
    }
    else if (posicion=='IM') //Izquierdo Medio
    {
        calendar_offsetTop=-100;
        calendar_offsetLeft=-210;
    }
    else if (posicion=='IS') //Izquierdo Superior
    {
        calendar_offsetTop=-180;
        calendar_offsetLeft=-210;
    }
	...
	//
	if (ValorIsFechaDPicker(inputField)==false)
	...
	//alert('mm  '+inputField.value.length);
	...
	//
	//Creando El Fondo Principal del DIV
//	document.getElementById('calendarDivFondo').style.display='block';
	//
	 return false;
...
function ValorIsFechaDPicker(ControlValor)
{
