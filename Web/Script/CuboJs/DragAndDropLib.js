...
//////window.onload = function(){
	...
	if(Demos[0]){
	    CreateDragContainer(document.getElementById('divContenedorFiltrosFilas'), document.getElementById('divContenedorFiltrosColumnas'), document.getElementById('divContenedorFiltrosExcluidas'));
