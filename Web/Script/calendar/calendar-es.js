...
"- o haga clic y arrastre el ratón para una selección más rapida.";

Zapatec.Calendar._TT["PREV_YEAR"] = "Año anterior (mantener para menu)";
Zapatec.Calendar._TT["PREV_MONTH"] = "Mes anterior (mantener para menu)";
Zapatec.Calendar._TT["GO_TODAY"] = "Ir a hoy";
Zapatec.Calendar._TT["NEXT_MONTH"] = "Mes siguiente (mantener para menu)";
Zapatec.Calendar._TT["NEXT_YEAR"] = "Año siguiente (mantener para menu)";
...
Zapatec.Calendar._TT["DAY_FIRST"] = "Hacer %s primer dia de la semana";
...
Zapatec.Calendar._TT["TIME_PART"] = "(May&uacute;scula-)Clic o arrastre para cambiar valor";
